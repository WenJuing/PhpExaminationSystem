...
//这里是查询得到的结果集
$result = mysqli_query($conn,"select * from multiple_choices where question='$ques'");
//判断单选表中是否有该题
...
elseif($ques=="" || $solution=="" || $a=="" || $b=="" || $c=="" || $d=="") {
    ...
    $sql="INSERT INTO multiple_choices(question,A,B,C,D,solution) VALUES('$ques','$a','$b','$c','$d','$solution')";
    //执行插入返回的结果
